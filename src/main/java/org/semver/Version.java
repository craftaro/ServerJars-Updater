...
/*
  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  Why copying the file instead of letting maven shade it?
  I would have to exclude unnecessary files that get shaded although never used.
  This just makes the whole process easier.

  Source: https://repo1.maven.org/maven2/org/semver/api/0.9.33/api-0.9.33-sources.jar
  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 */
package org.semver;
...
public final class Version implements Comparable<Version> {
    ...
    public static Version parse(final String version) {
        ...
        if (patchMatch != null && !patchMatch.trim().isEmpty()) {
    ...
    public boolean equals(final Object object) {
        ...
        return Objects.equals(this.special, other.special);
    }
    ...
    private static class Special implements Comparable<Special> {
        ...
        public int compareTo(Special other) {
            ...
            if (Math.max(other.ids.length, ids.length) != min) {
